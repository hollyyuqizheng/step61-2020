...
const SCOPE_CALENDAR_READ_ONLY =
...
function handleImportAuthError(e) {
  ...
  if (e.error === ERROR_CODES.popup_closed_by_user) {
    ...
    errorMessage = 'You didn\'t give permission to view your Google Account, ' +
 ...
 * Hides all API buttons accordinly, except the main "Log into your Google
 * account" button.
 */
